...
def extract_topics(prompt):
    response = pipe(f"Read the text below and list up to 3 topics. Each topic should contain fewer than 3 words. Ensure
                    you return three topics, separated by commas, and nothing more.{prompt}\n", 
